...
recipeDependencies {
    parserClasspath("org.apache.httpcomponents.core5:httpcore5:5.2.+")
    parserClasspath("org.apache.httpcomponents.client5:httpclient5:5.3.+")
...
dependencies {
    ...
    compileOnly("com.google.errorprone:error_prone_core:2.29.1") {
    ...
    testRuntimeOnly("org.apache.httpcomponents.client5:httpclient5:5.3.+")
